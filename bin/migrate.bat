...
ECHO =============================================================
python %PROJECT_NAME%\manage.py migrate --settings=%PROJECT_NAME%.settings.local
GOTO exit
...
ECHO =============================================================
python %PROJECT_NAME%\manage.py migrate --settings=%PROJECT_NAME%.settings.test
GOTO exit
...
ECHO =============================================================
python %PROJECT_NAME%\manage.py migrate --settings=%PROJECT_NAME%.settings.production
GOTO exit
